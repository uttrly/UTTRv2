                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2">
                            <MDBBtn className="btn btn-sm btn-outline" onclick="location.href='/dashboard';"><i class="fas fa-th-list"></i>My Goals</MDBBtn>
                            <MDBBtn className="btn btn-sm btn-outline" onclick="location.href='/dashboard/referee';"><i class="far fa-eye"></i>Referee</MDBBtn>
                        </div>

                        <div class="btn-group mr-2">
                            <MDBBtn className="btn btn-sm btn-outline" href='/createGoal' ><i className="far fa-plus-square"></i> Add New Goal</MDBBtn>
                        </div>
                    </div>
                </div>
