  ...
  render() {
    return(
      <MDBContainer className="my-5 pt-5 mainContainer">
        ...
        <p> UTTR currently collects your personal email when you sign up to become a member. We aso collect the email of your referee when you create a goal. We will contact your referee via the provided email to inform them that they are now the referee of your goal. Should they not already be a member they will be invited to create an account. We will also contact you via email should be be one of the lucky UTTR LOTTO winners. All member emails are stored in a cloud database. We use a third party service to send and receive emails. We do not sell any member or pending member email to any third party vender.</p>
